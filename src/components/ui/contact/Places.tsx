...
export const Places = (props: Layout132Props) => {
  ...
  sections: [
    {
      ...
      heading: "Canada",
      description:
        "Lorem ipsum mi quis viverra ornare diam libero vitae erat.",
      button: {
        title: "Button",
        variant: "link",
        size: "link",
    ...
    },
    {
      ...
      heading: "New York",
      description:
        "Lorem quis viverra ornare, eros dolor interdum vitae erat.",
      button: {
        title: "Button",
        variant: "link",
        size: "link",
